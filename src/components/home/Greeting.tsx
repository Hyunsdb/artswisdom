  ...
  return (
    <Section id="greeting" className="bg-[#FCF3EB] py-20 lg:py-28 relative">
      <div className="max-w-[1140px] mx-auto">
        {/* Top: Heading on single line, centered */}
        <motion.h2
          ...
          className="text-[32px] md:text-[44px] font-semibold text-[#85544D] leading-[1.2] tracking-normal text-center mb-12 md:mb-16 whitespace-nowrap"
        >
          Welcome to the Artswisdom
        </motion.h2>

        {/* Below: photo + body text aligned at top */}
        <div className="flex flex-col md:flex-row items-start gap-8">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
            className="w-full md:w-[45.077%] flex justify-center"
          >
            <div className="w-full shadow-[0_0_20px_rgba(0,0,0,0.15)] bg-white overflow-hidden" style={{ aspectRatio: '969/961' }}>
              <Image
                src={images.ceo.main}
                alt="대표이사 문수정"
                width={969}
          ...
          >
            <div style={{ fontFamily: '"Noto Sans KR", sans-serif' }} className="text-[#5B5B5B] text-[15px] font-normal leading-[1.8] tracking-normal space-y-[20px]">
              <p>
